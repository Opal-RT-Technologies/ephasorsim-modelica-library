...
partial model GenUnitExcGovUel
  "Core GenUnit model with Excitation System, Turbine Governor and Under-Excitation Limiter models"
  extends GenUnitExcGov;
