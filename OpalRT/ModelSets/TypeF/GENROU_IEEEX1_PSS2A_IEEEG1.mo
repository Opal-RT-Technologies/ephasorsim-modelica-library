...
model GENROU_IEEEX1_PSS2A_IEEEG1
  extends GenUnitTypeF1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ...
      SE_E1 = SE_E1_ex,
      E2 = E2_ex,
      SE_E2 = SE_E2_ex), redeclare Electrical.Control.Stabilizer.PSS2A stabilizer(
      M2 = M2_pss,
      TW1 = TW1_pss,
      TW2 = TW2_pss,
      T6 = T6_pss,
      ...
      ID = PSS_ID), redeclare Electrical.Control.TurbineGovernor.IEEEG1 turbineGovernor(
      IBUS = 100,
      ID = M_ID,
      K = K_tg,
      T1 = T1_tg,
