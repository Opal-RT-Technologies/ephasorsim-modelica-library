...
model GENROU_ESST3A_PSS2A_WSIEG1
  extends GenUnitTypeF1(redeclare OpalRT.Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ...
      TM = TM_ex,
      VMMAX = VMMAX_ex,
      VMMIN = VMMIN_ex), redeclare OpalRT.Electrical.Control.Stabilizer.PSS2A stabilizer(
      TW1 = TW1_pss,
      TW2 = TW2_pss,
      T6 = T6_pss,
      TW3 = TW3_pss,
      ...
      y_start = 0), redeclare OpalRT.Electrical.Control.TurbineGovernor.WSIEG1 turbineGovernor(
      IBUS = IBUS,
      ID = M_ID,
      K = K_tg,
      T1 = T1_tg,
