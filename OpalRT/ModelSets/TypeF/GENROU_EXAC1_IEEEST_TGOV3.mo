...
model GENROU_EXAC1_IEEEST_TGOV3
  extends GenUnitTypeF2(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      IBUS = IBUS,
      ID = M_ID,
      P_gen = P_gen,
      Q_gen = Q_gen,
      ...
      E2 = E2_ex,
      SE_E2 = SE_E2_ex,
      IBUS = IBUS), redeclare Electrical.Control.Stabilizer.IEEEST stabilizer(
      IBUS = IBUS,
      ID = M_ID,
      A1 = A1_pss,
      A2 = A2_pss,
      ...
      VCL = VCL_pss,
      M0 = M0_pss,
      M1 = M1_pss), redeclare Electrical.Control.TurbineGovernor.TGOV3 turbineGovernor(
      IBUS = IBUS,
      ID = M_ID,
      K = K_tg,
      T1 = T1_tg,
...
equation
  connect(add2.y, turbineGovernor.vTrig) annotation (Line(points={{-52,-48.5},{
          -52,-34.6},{2,-34.6}}, color={0,0,127}));
