...
model GENSAE_IEEEX1_UEL2
  extends GenUnitTypeG1(redeclare Electrical.Machine.SynchronousMachine.GENSAE synchronousGenerator(
      ID = M_ID,
      P_gen = P_gen,
      Q_gen = Q_gen,
      Vt_abs = Vt_abs,
      ...
      SE_E1 = SE_E1_ex,
      E2 = E2_ex,
      SE_E2 = SE_E2_ex), redeclare Electrical.Control.UnderExcitationLimiter.UEL2 uel(
      TUV = TUV_uel,
      TUP = TUP_uel,
      TUQ = TUQ_uel,
      KUI = KUI_uel,
  ...
  // --------- GENSAE Parameters (aliased from machineData / generalData) ---------
  parameter Integer IBUS = 100 "Located system bus" annotation(Dialog(tab = "General"));
  parameter String M_ID = "M1" "Machine Identifier" annotation(Dialog(tab = "GENSAE Parameters"));
  ...
  parameter Real Tqo_s = 0.01 "q-axis sub-transient time constant, s" annotation(Dialog(tab = "GENSAE Parameters"));
  ...
  parameter Real S1 = 0.4 "Saturation function at 1.0 p.u." annotation(Dialog(tab = "GENSAE Parameters"));
  parameter Real S12 = 0.8 "Saturation function at 1.2 p.u." annotation(Dialog(tab = "GENSAE Parameters"));

  // --------- IEEEX1 Parameters (aliased from exciterData) ---------
