...
model GENROU_TGOV3
  extends GenUnitTypeC2(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      IBUS = IBUS,
      ID = M_ID,
      P_gen = P_gen,
      Q_gen = Q_gen,
      ...
      Xl = Xl,
      S1 = S1,
      S12 = S12), redeclare Electrical.Control.TurbineGovernor.TGOV3 turbineGovernor(
      IBUS = IBUS,
      ID = M_ID,
      K = K_tg,
      T1 = T1_tg,
...
equation
  connect(add2.y, turbineGovernor.vTrig) annotation (Line(points={{-73.5,-77},{-73.5,
          -78},{-60,-78},{-60,-44.6},{-18,-44.6}},     color={115,170,0}));
end GENROU_TGOV3;
