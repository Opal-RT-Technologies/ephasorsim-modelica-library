...
model GENROU_EXAC2_MAXEX1_UEL2
  extends GenUnitTypeK1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ID = M_ID,
      P_gen = P_gen,
      Q_gen = Q_gen,
      Vt_abs = Vt_abs,
      ...
      M0 = M0_uel,
      M1 = M1_uel,
      M2 = M2_uel), redeclare Electrical.Control.OverExcitationLimiter.MAXEX1 oel(
  ...
  // --------- EXAC2 Parameters (aliased from exciterData) ---------
