...
model GENROU_ESST4B_WSHYDD
  extends GenUnitTypeD1(constVOEL(k=noVOEL), redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      IBUS=IBUS,
      ID=M_ID,
      P_gen=P_gen,
      Q_gen=Q_gen,
      ...
      KC=KC_ex,
      XL=XL_ex,
      THETAP=THETAP_ex), redeclare Electrical.Control.TurbineGovernor.WSHYDD turbineGovernor(
      db1=db1_tg,
      err=err_tg,
      Td=Td_tg,
      K1=K1_tg,
