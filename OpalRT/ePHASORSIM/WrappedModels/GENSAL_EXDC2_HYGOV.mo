...
block GENSAL_EXDC2_HYGOV
  extends Wrappers.FMUTemplateVRefGRef(redeclare ModelSets.TypeD.GENSAL_EXDC2_HYGOV modelSet(
      partType = partType,
      IBUS = IBUS,
      ID = ID,
      P_gen = P_gen,
...
// >>> AUTOGEN PARAMS (VERBATIM FROM MODELSETS) BEGIN
  ...
  parameter Real TC_ex = 400 "(sec)" annotation(Dialog(tab = "EXDC2 Parameters"));
  ...
  parameter Real KE_ex = 0.2 "or zero" annotation(Dialog(tab = "EXDC2 Parameters"));
