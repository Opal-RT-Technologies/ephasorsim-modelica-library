...
partial block FMUTemplateTwoPowerPinControl
  ...
  replaceable OpalRT.ModelSets.TwoPinControlPorts modelSet
...
equation
  ...
  connect(modelSet.bus0, bus0_PIN2INOUT.p) annotation (Line(points={{18.72,27.4},
          {30,27.4},{30,-8},{40,-8}},  color={0,0,0}));
  connect(modelSet.bus1, bus0_PIN2INOUT1.p) annotation (Line(points={{-17.64,
          27.4},{-40,27.4},{-40,-48},{40,-48}},
                                        color={0,0,0}));
  ...
  connect(modelSet.dVSCHED, dVSCHED) annotation (Line(points={{-18,32.8},{-60,32.8},{-60,100}}, color={0,0,0}));
  connect(modelSet.dSETVL, dSETVL) annotation (Line(points={{-18,50.8},{-40,
          50.8},{-40,80},{60,80},{60,100}},
                                     color={0,0,0}));
end FMUTemplateTwoPowerPinControl;
