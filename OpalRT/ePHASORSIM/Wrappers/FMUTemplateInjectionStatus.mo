...
partial block FMUTemplateInjectionStatus
  ...
  OpalRT.NonElectrical.Connector.InputInterfacePin STATUS
    annotation (Placement(transformation(extent={{-6,-6},{6,6}},
        rotation=-90,
        origin={0,100})));
  replaceable OpalRT.ModelSets.InjectionStatus modelSet
...
equation
  ...
  connect(STATUS, modelSet.STATUS) annotation (Line(points={{0,100},{0,38}}, color={0,0,0}));
  connect(modelSet.bus0, bus0_PIN2INOUT.p) annotation (Line(points={{18.72,7.4},
          {40,7.4},{40,-40},{52,-40}}, color={0,0,0}));
end FMUTemplateInjectionStatus;
