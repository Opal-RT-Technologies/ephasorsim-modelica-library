...
partial block FMUTemplateVRefGRefTrip
  ...
  OpalRT.NonElectrical.Connector.InputInterfacePin TRIP
    annotation (Placement(transformation(extent={{-6,-6},{6,6}},
        rotation=-90,
        origin={0,100})));
  replaceable OpalRT.ModelSets.TypeF.GenUnitTypeF2 modelSet
...
equation
  ...
  connect(vTRIP, modelSet.vTrig) annotation (Line(points={{-60,-100},{-60,3.8},{-18,3.8}}, color={0,0,0}));
end FMUTemplateVRefGRefTrip;
