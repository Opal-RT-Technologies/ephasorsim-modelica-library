...
model GENROU_ESAC2A
  extends GenUnitTypeB1(constVOEL(k=Modelica.Constants.inf), constVUEL(k=-Modelica.Constants.inf), redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ID=M_ID,
      P_gen=P_gen,
      Q_gen=Q_gen,
      Vt_abs=Vt_abs,
      ...
      Xl=Xl,
      S1=S1,
      S12=S12), redeclare Electrical.Control.Excitation.ESAC2A exciter(
      TR=TR_ex,
      TB=TB_ex,
      TC=TC_ex,
      KA=KA_ex,
