...
model GENSAL_IEEEX1_STAB1_HYGOV
  extends GenUnitTypeF1(redeclare Electrical.Machine.SynchronousMachine.GENSAL synchronousGenerator(
      ...
      SE_E1 = SE_E1_ex,
      E2 = E2_ex,
      SE_E2 = SE_E2_ex), redeclare Electrical.Control.Stabilizer.STAB1 stabilizer(
      K_T = K_T_pss,
      T = T_pss,
      T1_T3 = T1_T3_pss,
      T3 = T3_pss,
      T2_T4 = T2_T4_pss,
      T4 = T4_pss,
      HLIM = HLIM_pss), redeclare Electrical.Control.TurbineGovernor.HYGOV turbineGovernor(
      R = R_tg,
      r = r_tg,
      Tr = Tr_tg,
      Tf = Tf_tg,
