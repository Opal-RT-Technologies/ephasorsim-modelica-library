...
model GENROU_ESST3A_ST2CUT_IEEEG1
  extends GenUnitTypeF1(redeclare OpalRT.Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ...
      TM = TM_ex,
      VMMAX = VMMAX_ex,
      VMMIN = VMMIN_ex), redeclare OpalRT.Electrical.Control.Stabilizer.ST2CUT stabilizer(
      ID = M_ID,
      K1 = K1_pss,
      K2 = K2_pss,
      T1 = T1_pss,
      ...
      M1 = M1_pss,
      M2 = M2_pss,
      M3 = M3_pss), redeclare OpalRT.Electrical.Control.TurbineGovernor.IEEEG1 turbineGovernor(
      K = K_tg,
      T1 = T1_tg,
      T2 = T2_tg,
      T3 = T3_tg,
