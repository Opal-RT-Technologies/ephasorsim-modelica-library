...
model GENROU_REXSYS_PSS2A_GGOV1
  extends GenUnitTypeF1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ...
      E2 = E2_ex,
      SE_E2 = SE_E2_ex,
      F1IMF = F1IMF_ex), redeclare Electrical.Control.Stabilizer.PSS2A stabilizer(
      TW1 = TW1_pss,
      TW2 = TW2_pss,
      T6 = T6_pss,
      TW3 = TW3_pss,
      ...
      M3 = M3_pss,
      M4 = M4_pss,
      M5 = M5_pss), redeclare Electrical.Control.TurbineGovernor.GGOV1 turbineGovernor(
      R = R_tg,
      Tpelec = Tpelec_tg,
      maxerr = maxerr_tg,
      minerr = minerr_tg,
