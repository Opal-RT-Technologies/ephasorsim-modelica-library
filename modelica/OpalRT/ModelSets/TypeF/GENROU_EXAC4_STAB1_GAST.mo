...
model GENROU_EXAC4_STAB1_GAST
  extends GenUnitTypeF1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ...
      Xl = Xl,
      S1 = S1,
      S12 = S12), redeclare Electrical.Control.Excitation.EXAC4 exciter(
      TR = TR_ex,
      VIMAX = VIMAX_ex,
      VIMIN = VIMIN_ex,
      TC = TC_ex,
      ...
      VRMAX = VRMAX_ex,
      VRMIN = VRMIN_ex,
      KC = KC_ex), redeclare Electrical.Control.Stabilizer.STAB1 stabilizer(
      K_T = K_T_pss,
      T = T_pss,
      T1_T3 = T1_T3_pss,
      T3 = T3_pss,
      T2_T4 = T2_T4_pss,
      T4 = T4_pss,
      HLIM = HLIM_pss), redeclare Electrical.Control.TurbineGovernor.GAST turbineGovernor(
      R = R_tg,
      T1 = T1_tg,
      T2 = T2_tg,
      T3 = T3_tg,
