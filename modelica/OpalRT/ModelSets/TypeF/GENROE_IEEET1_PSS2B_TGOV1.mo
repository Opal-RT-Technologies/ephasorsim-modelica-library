...
model GENROE_IEEET1_PSS2B_TGOV1
  extends GenUnitTypeF1(redeclare Electrical.Machine.SynchronousMachine.GENROE synchronousGenerator(
      P_gen = P_gen,
      Q_gen = Q_gen,
      Vt_abs = Vt_abs,
      Vt_ang = Vt_ang,
      ...
      VS2MAX = VS2MAX_pss,
      VS2MIN = VS2MIN_pss,
      y_start = 0), redeclare Electrical.Control.TurbineGovernor.TGOV1 turbineGovernor(
      R = R_tg,
      T1 = T1_tg,
      VMAX = VMAX_tg,
      VMIN = VMIN_tg,
