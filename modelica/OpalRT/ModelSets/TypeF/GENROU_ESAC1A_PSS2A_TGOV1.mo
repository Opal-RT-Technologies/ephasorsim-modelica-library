...
model GENROU_ESAC1A_PSS2A_TGOV1
  extends GenUnitTypeF1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ...
      SE_E2 = SE_E2_ex,
      VRMAX = VRMAX_ex,
      VRMIN = VRMIN_ex), redeclare Electrical.Control.Stabilizer.PSS2A stabilizer(
      M2 = M2_pss,
      TW1 = TW1_pss,
      TW2 = TW2_pss,
      T6 = T6_pss,
      ...
      ID = M_ID), redeclare Electrical.Control.TurbineGovernor.TGOV1 turbineGovernor(
      R = R_tg,
      T1 = T1_tg,
      VMAX = VMAX_tg,
      VMIN = VMIN_tg,
      T2 = T2_tg,
      T3 = T3_tg,
      Dt = Dt_tg), constVOEL(k = noVOEL), constVUEL(k = noVUEL));
