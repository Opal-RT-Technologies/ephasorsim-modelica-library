...
model GENROU_EXST1_STAB3_IEESGO
  extends GenUnitTypeF1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ...
      KC = KC_ex,
      KF = KF_ex,
      TF = TF_ex), redeclare Electrical.Control.Stabilizer.STAB3 stabilizer(
      Tt = Tt_pss,
      Tx1 = Tx1_pss,
      Tx2 = Tx2_pss,
      Kx = Kx_pss,
      VLIM = VLIM_pss), redeclare Electrical.Control.TurbineGovernor.IEESGO turbineGovernor(
      T1 = T1_tg,
      T2 = T2_tg,
      T3 = T3_tg,
      T4 = T4_tg,
