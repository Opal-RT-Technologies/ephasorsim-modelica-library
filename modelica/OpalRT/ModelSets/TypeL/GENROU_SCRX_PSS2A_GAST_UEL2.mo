...
model GENROU_SCRX_PSS2A_GAST_UEL2
  extends GenUnitTypeL1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      IBUS=IBUS,
      ID=M_ID,
      P_gen=P_gen,
      Q_gen=Q_gen,
      ...
      EMAX=EMAX_ex,
      CSWITCH=CSWITCH_ex,
      rc_rfd=rc_rfd_ex), redeclare Electrical.Control.Stabilizer.PSS2A stabilizer(
      M2=M2_pss,
      TW1=TW1_pss,
      TW2=TW2_pss,
      T6=T6_pss,
      ...
      DTURB=DTURB_tg,
      IBUS=IBUS,
      ID=M_ID), redeclare Electrical.Control.UnderExcitationLimiter.UEL2 uel(
      TUV = TUV_uel,
      TUP = TUP_uel,
      TUQ = TUQ_uel,
      KUI = KUI_uel,
