...
equation
  connect(cimtr3.STATUS, STATUS) annotation(Line(points={{-25,20},{-56.9476,20},
          {-56.9476,46},{80,46}},                                                                                 color = {0, 0, 127}));
  connect(bus0, cimtr3.p) annotation(Line(points={{106,-30},{62.7451,-30},{
          62.7451,-22.658},{27.5,-22.658},{27.5,-22.5}}));
end CIMTR3S;
