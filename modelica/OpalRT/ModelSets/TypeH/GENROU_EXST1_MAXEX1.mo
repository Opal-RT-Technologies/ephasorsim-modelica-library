...
model GENROU_EXST1_MAXEX1 "GENROU + EXST1 + MAXEX1 using the TypeH GenUnitTypeH1 template"
  extends GenUnitTypeH1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      IBUS = IBUS,
      ID = M_ID,
      P_gen = P_gen,
      Q_gen = Q_gen,
      ...
      KC = KC_ex,
      KF = KF_ex,
      TF = TF_ex), redeclare Electrical.Control.OverExcitationLimiter.MAXEX1 oel(
