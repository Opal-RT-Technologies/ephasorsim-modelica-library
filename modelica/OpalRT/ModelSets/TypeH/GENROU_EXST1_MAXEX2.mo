...
model GENROU_EXST1_MAXEX2 "GENROU + EXST1 + MAXEX2 using the TypeH GenUnitTypeH1 template"
  extends GenUnitTypeH1(redeclare Electrical.Machine.SynchronousMachine.GENROU synchronousGenerator(
      ...
      KC = KC_ex,
      KF = KF_ex,
      TF = TF_ex), redeclare Electrical.Control.OverExcitationLimiter.MAXEX2 oel(
