...
model GENROE_ESST1A_PSS2A
  extends GenUnitTypeE1(constVUEL(k=noVUEL), constVOEL(k=noVOEL), redeclare Electrical.Machine.SynchronousMachine.GENROE synchronousGenerator(
      IBUS=IBUS,
      ID=M_ID,
      P_gen=P_gen,
      Q_gen=Q_gen,
