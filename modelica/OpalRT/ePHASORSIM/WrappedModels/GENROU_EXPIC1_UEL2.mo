...
block GENROU_EXPIC1_UEL2
  extends Wrappers.FMUTemplateVRef(redeclare ModelSets.TypeG.GENROU_EXPIC1_UEL2 modelSet(
      partType = partType,
      IBUS = IBUS,
      M_ID = M_ID,
      P_gen = P_gen,
...
// >>> AUTOGEN PARAMS (VERBATIM FROM MODELSETS) BEGIN
  ...
  // --------- EXPIC1 Parameters (aliased from exciterData) ---------
  parameter Real TR_ex = 0.1 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real KA_ex = 0.2 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real TA1_ex = 12 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real VR1_ex = 5 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real VR2_ex = -5 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real TA2_ex = 10 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real TA3_ex = 400 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real TA4_ex = 5 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real VRMAX_ex = 5 annotation(Dialog(tab = "EXPIC1 Parameters"));
  ...
  parameter Real TF1_ex = 1.2 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real TF2_ex = 1.2 annotation(Dialog(tab = "EXPIC1 Parameters"));
  parameter Real EFDMAX_ex = 5 annotation(Dialog(tab = "EXPIC1 Parameters"));
  ...
  parameter Real TE_ex = 0.08 annotation(Dialog(tab = "EXPIC1 Parameters"));
  ...
  parameter Real KI_ex = 0.5 annotation(Dialog(tab = "EXPIC1 Parameters"));
