...
block GENROU_ESST1A_UEL2_OLD
  ...
  OpalRT.NonElectrical.Connector.InputInterfacePin TRIP
    annotation (Placement(transformation(extent={{-6,-6},{6,6}},
        rotation=-90,
        origin={0,100})));
  ModelSets.Old.GENROU_ESST1A_UEL2_OLD modelSet(
      partType = partType,
      IBUS = IBUS,
      M_ID = M_ID,
      P_gen = P_gen,
...
equation
  ...
  connect(TRIP, modelSet.TRIP)
    annotation (Line(points={{0,100},{0,52},{-28,52},{-28,34.4},{-18,34.4}},
                                              color={0,0,0}));
  connect(modelSet.bus0, bus0_PIN2INOUT.p) annotation (Line(points={{18,14.24},{
          40,14.24},{40,-40},{52,-40}},color={0,0,0}));
