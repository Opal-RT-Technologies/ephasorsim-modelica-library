...
model SM_GENSAE "Single-machine FMU for GENSAE (partType=2)"
  ...
  OpalRT.Electrical.Machine.SynchronousMachine.GENSAE machine(
    IBUS = IBUS,
    ID = ID,
    P_gen = P_gen,
    Q_gen = Q_gen,
  ...
  parameter Real ZSOURCE_RE = 0 "Machine source impedance" annotation(Dialog(tab = "GENSAE Parameters"));
  parameter Real Tdo_p = 7 "d-axis transient time constant" annotation(Dialog(tab = "GENSAE Parameters"));
  parameter Real Tdo_s = 0.03 "d-axis sub-transient time constant, s" annotation(Dialog(tab = "GENSAE Parameters"));
  parameter Real Tqo_s = 0.04 "q-axis sub-transient time constant, s" annotation(Dialog(tab = "GENSAE Parameters"));
  ...
  parameter Real Xl = 0.03 "Leakage reactance, p.u." annotation(Dialog(tab = "GENSAE Parameters"));
  parameter Real S1 = 0.4 "Saturation at 1 p.u." annotation(Dialog(tab = "GENSAE Parameters"));
  parameter Real S12 = 0.8 "Saturation at 1.2 p.u." annotation(Dialog(tab = "GENSAE Parameters"));
