...
block GENROU_EXST3_PSS2A
  extends Wrappers.FMUTemplateVRef(redeclare ModelSets.TypeE.GENROU_EXST3_PSS2A modelSet(
      partType = partType,
      IBUS = IBUS,
      M_ID = M_ID,
      P_gen = P_gen,
...
// >>> AUTOGEN PARAMS (VERBATIM FROM MODELSETS) BEGIN
  ...
  parameter Real VIMAX_ex = 3 "(pu)" annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real VIMIN_ex = -3 "(pu)" annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real KJ_ex = 0.2 annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real TC_ex = 12 "(sec)" annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real TB_ex = 12 "(sec)" annotation(Dialog(tab = "EXST2 Parameters"));
  ...
  parameter Real KG_ex = 0.2 annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real KP_ex = 0.4 annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real KI_ex = 0.5 annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real XL_ex = 0.4 annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real KC_ex = 0.5 annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real EFDMAX_ex = 5 annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real VGMAX_ex = 10 annotation(Dialog(tab = "EXST2 Parameters"));
  parameter Real THETAP_ex = 0.4 annotation(Dialog(tab = "EXST2 Parameters"));
  // PSS2A Parameters
