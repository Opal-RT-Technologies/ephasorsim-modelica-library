...
block GENROU_IEEET2_TGOV1
  extends Wrappers.FMUTemplateVRefGRef(redeclare ModelSets.TypeD.GENROU_IEEET2_TGOV1 modelSet(
      partType = partType,
      IBUS = IBUS,
      M_ID = M_ID,
      P_gen = P_gen,
...
// >>> AUTOGEN PARAMS (VERBATIM FROM MODELSETS) BEGIN
  ...
  // TGOV1 Parameters
  parameter Real R_tg = 0.05 annotation(Dialog(tab = "TGOV1"));
  parameter Real T1_tg = 0.5 "(>0) (sec)" annotation(Dialog(tab = "TGOV1"));
  parameter Real VMAX_tg = 3 annotation(Dialog(tab = "TGOV1"));
  parameter Real VMIN_tg = 0 annotation(Dialog(tab = "TGOV1"));
  parameter Real T2_tg = 2.1 annotation(Dialog(tab = "TGOV1"));
  parameter Real T3_tg = 7 "(>0) (sec)" annotation(Dialog(tab = "TGOV1"));
  parameter Real Dt_tg = 0 annotation(Dialog(tab = "TGOV1"));
