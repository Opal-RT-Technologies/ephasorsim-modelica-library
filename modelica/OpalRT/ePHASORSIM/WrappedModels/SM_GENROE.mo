...
model SM_GENROE "Single-machine FMU for GENROE (partType=2)"
  ...
  OpalRT.Electrical.Machine.SynchronousMachine.GENROE machine(
    IBUS = IBUS,
    ID = ID,
    P_gen = P_gen,
    Q_gen = Q_gen,
  ...
  parameter Real ZSOURCE_RE = 0 "Machine source impedance" annotation(Dialog(tab = "GENROE Parameters"));
  ...
  parameter Real Tqo_s = 0.04 "q-axis sub-transient time constant, s" annotation(Dialog(tab = "GENROE Parameters"));
  ...
  parameter Real Xl = 0.03 "Leakage reactance, p.u." annotation(Dialog(tab = "GENROE Parameters"));
  parameter Real S1 = 0.4 "Saturation at 1 p.u." annotation(Dialog(tab = "GENROE Parameters"));
  parameter Real S12 = 0.8 "Saturation at 1.2 p.u." annotation(Dialog(tab = "GENROE Parameters"));
