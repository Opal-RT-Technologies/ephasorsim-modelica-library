...
block GENROU_ST5B_OLD
  ...
  OpalRT.NonElectrical.Connector.InputInterfacePin TRIP
    annotation (Placement(transformation(extent={{-6,-6},{6,6}},
        rotation=-90,
        origin={0,100})));
  ModelSets.Old.GENROU_ST5B_OLD modelSet(
      partType = partType,
      IBUS = IBUS,
      M_ID = M_ID,
      P_gen = P_gen,
...
equation
  ...
  connect(TRIP, modelSet.TRIP)
    annotation (Line(points={{0,100},{0,34.4}},
                                              color={0,0,0}));
  ...
  connect(modelSet.dVREF, dVREF)
    annotation (Line(points={{-16.2,9.2},{-60,9.2},{-60,100}}, color={0,0,0}));
