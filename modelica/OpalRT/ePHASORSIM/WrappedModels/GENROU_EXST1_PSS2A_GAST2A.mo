...
block GENROU_EXST1_PSS2A_GAST2A
  extends Wrappers.FMUTemplateVRefGRef(redeclare ModelSets.TypeF.GENROU_EXST1_PSS2A_GAST2A modelSet(
      partType = partType,
      IBUS = IBUS,
      M_ID = M_ID,
      P_gen = P_gen,
...
// >>> AUTOGEN PARAMS (VERBATIM FROM MODELSETS) BEGIN
  ...
  parameter Real X_tg = 1e-07 "governor lead time constant, sec." annotation(Dialog(tab = "GAST2A Parameters"));
