...
partial block FMUTemplateInjectionVOTHSGVRef
  ...
  replaceable OpalRT.ModelSets.InjectionVOTHSGVRef modelSet
    annotation (Placement(transformation(extent={{-18,2},{18,38}})));
  OpalRT.NonElectrical.Connector.InputInterfacePin VOTHSG annotation (Placement(
        transformation(
        extent={{-6,-6},{6,6}},
        rotation=-90,
        origin={60,100})));
...
equation
  ...
  connect(modelSet.VOTHSG, VOTHSG) annotation (Line(points={{-18,9.2},{-40,9.2},{
          -40,60},{60,60},{60,100}}, color={0,0,0}));
  connect(modelSet.dVREF, dVREF) annotation (Line(points={{-18,30.8},{-60,30.8},{-60,100}}, color={0,0,0}));
end FMUTemplateInjectionVOTHSGVRef;
