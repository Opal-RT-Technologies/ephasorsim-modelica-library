...
equation
  ...
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={                                                                                                                                                               Text(origin = {-58.6044, 57.9194}, extent = {{-38.33, 8.2}, {73.12, -30.27}}, textString = "P+jQ"), Text(origin={
              -59.5104,8.11932},                                                                                                                                                                                                        extent={{
              -35.444,7.14005},{55.5104,-24.1193}},                                                                                                                                                                                                        textString = "Const. PQ"), Rectangle(origin = {0.256739, -0.256739}, extent = {{-100.128, 99.8716}, {99.6149, -99.8716}}), Text(origin = {-137.193, -25.5469}, extent = {{50.7586, 5.37587}, {73.12, -30.27}}, textString = "P"), Text(origin = {-136.96, -64.34}, extent = {{50.76, 5.38}, {71.5796, -26.4189}}, textString = "Q"),
        Polygon(
